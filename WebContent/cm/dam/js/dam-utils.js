...
(function (root, factory) {
    ...
    var MESSAGES = {
        ...
        'dam.validation.required': 'Vui long nhap {0}.',
        'dam.validation.selectRequired': 'Vui long chon {0}.',
        'dam.validation.maxLength': '{0} toi da {1} ky tu.',
        'dam.validation.number': '{0} phai la so hop le.',
        'dam.validation.numberMin': '{0} phai lon hon hoac bang {1}.',
        'dam.validation.numberMax': '{0} phai nho hon hoac bang {1}.',
        'dam.validation.email': '{0} khong dung dinh dang email.',
        'dam.validation.phone': '{0} khong dung dinh dang so dien thoai.',
        'dam.validation.fileName.invalidChar': 'File Name khong duoc chua: / \\ : * ? " < > |',
        'dam.validation.status': 'Status khong hop le.',
        'dam.validation.assetType': 'Asset Type khong hop le.',
        'dam.validation.tags.maxCount': 'Toi da {0} tags.',
        'dam.validation.tags.maxLength': 'Moi tag toi da {0} ky tu.',
        'dam.validation.fileSize': 'File Size phai la so hoac kich thuoc hop le (vd: 12 MB).',
        'dam.asset.selectRequired': 'Vui long chon asset truoc khi submit.',
        'dam.asset.changeLogRequired': 'Change Log la bat buoc de tao version moi.',
        'dam.asset.updateFailed': 'Khong cap nhat duoc thong tin asset trong DB.',
        'dam.asset.versionCreateFailed': 'Khong tao duoc version moi trong DB.',
        'dam.asset.submitSuccess': 'Submit thanh cong. Da cap nhat asset va tao version moi: {0}.',
        'dam.version.assetMissing': 'Khong tim thay asset de cap nhat.',
        'dam.version.notFound': 'Khong co version trong database de cap nhat.',
        'dam.version.updateSuccess': 'Cap nhat version thanh cong.',
        'dam.confirm.saveChanges': 'Ban co chac muon luu thay doi?',
        'dam.confirm.submitVersion': 'Ban co chac muon cap nhat asset va tao version moi?',
        'dam.confirm.updateVersion': 'Ban co chac muon cap nhat thong tin version?',
        'dam.api.saveFailed': 'Luu that bai. HTTP {0}.',
        'dam.api.networkFailed': 'Khong the ket noi server. Vui long thu lai.'
    };
