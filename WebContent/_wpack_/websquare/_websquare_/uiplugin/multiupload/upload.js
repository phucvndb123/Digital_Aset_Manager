/*amd /websquare/_websquare_/uiplugin/multiupload/upload.xml 20964 e589a7ee27490be9baf5eadbbd3f274321ccfef390a4ab3074882b6a7bf6f97b */
define({E:[{T:1,N:'html',A:{xmlns:'http://www.w3.org/1999/xhtml','xmlns:ev':'http://www.w3.org/2001/xml-events','xmlns:w2':'http://www.inswave.com/websquare','xmlns:xf':'http://www.w3.org/2002/xforms'},E:[{T:1,N:'head',E:[{T:1,N:'xf:model',E:[{T:1,N:'xf:instance',_xml:'<xf:instance xmlns:xf="http://www.w3.org/2002/xforms">\n                <data xmlns="">\n                	<popupParams>\n                		<key/>\n                		<fileList/>\n                		<fileName/>\n                	</popupParams>\n                </data>\n            </xf:instance>'},{T:1,N:'xf:submission',A:{action:'/websquare/delete.wq',id:'deleteFile',mediatype:'text/xml',method:'post',ref:'popupParams',replace:'none'},E:[{T:1,N:'script',A:{'ev:event':'xforms-submit-done',type:'javascript'},E:[{T:4,cdata:function(scopeObj){with(scopeObj){
...
}}}]},{T:1,N:'script',A:{'ev:event':'xforms-submit-error',type:'javascript'},E:[{T:4,cdata:function(scopeObj){with(scopeObj){
                	WebSquare.layer.hideProcessMessage();
				
}}}]},{T:1,N:'script',A:{'ev:event':'xforms-submit',type:'javascript'},E:[{T:4,cdata:function(scopeObj){with(scopeObj){
                	WebSquare.layer.showProcessMessage( "삭제 중 입니다." );
				
}}}]}]}]},{T:1,N:'script',A:{type:'javascript'},E:[{T:4,cdata:function(scopeObj){with(scopeObj){
...
// 				fileKey = WebSquare.ModelUtil.getInstanceValue(xpath + "/key");
			...
			titleImage.style.width = 16;
			titleImage.style.height = 13;
...
//			titleTable.setCellContents(0,0,titleSpan, "width:350px;font-weight:bold; font-size:12px; color:#375088; vertical-align:top");
			...
			tableObj.render.border = 0;
			tableObj.render.cellPadding = 0;
			tableObj.render.cellSpacing = 0;
			...
			tableObj2.callClass("uploadTable2",2,2,"z-index:0; overflow:hidden; width:400; height:100%;margin: 0px 0px 0px 0px; padding: 0px 0px 0px 0px; border-collapse:collapse; border:0px none black; height:30px "," margin: 0px 0px 0px 0px; padding: 0px 0px 0px 0px; border-collapse:collapse; border:0px solid black; height:30px;text-align:center");
			...
			//동적 추가 로직 
     		if( mode == 1 ) { //동적 추가 불가
				...
				WebSquare.event.addListener(addButton,"onclick", function(e) { 
					...
					tableObj.render.style.height = parseInt(tableObj.render.style.height) + 30;
					tableObj.addRow();
					var obj = createTR();
				...
				delButton.style.width = 72;
				delButton.style.height = 18;
			...
			layerUP.style.width="0";
			layerUP.style.height="0";
			layerUP.style.visibility = "hidden";
			document.body.appendChild(layerUP);
			layerUP.innerHTML = "<iframe frameborder='0' name='__targetFrame__' scrolling='no' style='width:0; height:0'></iframe>";
