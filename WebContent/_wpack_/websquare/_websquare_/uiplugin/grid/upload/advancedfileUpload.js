/*amd /websquare/_websquare_/uiplugin/grid/upload/advancedfileUpload.xml 54522 a8a8c58761fdb773c69badec9c3bda5efbf753f094fc5297e414c5206c6eb163 */
define({declaration:{A:{version:'1.0',encoding:'UTF-8'}},E:[{T:1,N:'html',A:{xmlns:'http://www.w3.org/1999/xhtml','xmlns:ev':'http://www.w3.org/2001/xml-events','xmlns:w2':'http://www.inswave.com/websquare','xmlns:xf':'http://www.w3.org/2002/xforms'},E:[{T:1,N:'head',E:[{T:1,N:'w2:type',E:[{T:3,text:'DEFAULT'}]},{T:1,N:'w2:buildDate'},{T:1,N:'xf:model',E:[{T:1,N:'w2:dataCollection',A:{baseNode:'map'}},{T:1,N:'w2:workflowCollection'}]},{T:1,N:'style',A:{type:'text/css'},E:[{T:4,cdata:'/*\n                html, body {margin:0px; padding:0px; font-family:"맑은 고딕"; font-size:11px;}\n                p {margin:0px; padding:0px;}\n                img, fieldset {border:0;}\n                table {width:100%; background:#fff; border-collapse:collapse; border-spacing:0; empty-cells:show;}\n                table caption, table summary {width:0; height:0; font-size:0; line-height:0; overflow:hidden; visibility:hidden;}\n                */.none{display:none}.block{display:block}.exup_wrap{width:444px;min-height:106px;border:1px solid #b3b3b3}.exup_header{height:27px}.exup_header .title{padding-left:28px;font-weight:bold;line-height:23px}.exup_header .title2{padding-left:28px;font-weight:bold;line-height:23px;float:left}.exup_header span{padding-right:20px;float:right;display:block}.exup_header span input[type=checkbox]{position:relative;top:1px}/*.exup_header span table {position:relative; top:1px;}*/.exup_spanGroup{background-color:transparent}.exup_content{padding:15px 10px 12px}.exup_content .filebox{padding:8px 0 0 11px;width:408px;height:33px;border:1px solid #d3d3d3;background:#f6f6f6}.exup_content .filebox span{display:inline-block;width:300px;height:21px;font-family:Verdana;font-size:12px;background:#fff}.exup_tbl{margin:15px auto 0;width:400px}.exup_tbl th,.tbl td{min-width:100px;height:24px;text-align:left}.exup_tbl th .dot{padding-left:14px}.exup_tbl td .ipt{width:74px;height:16px/*bordeR:1px solid #abadb3;*/}.exup_tbl td .sel{width:80px;height:20px}.btn_exup_file{margin-bottom:14px;width:90px;position:relative;left:333px;border-radius:4px}'}]},{T:1,N:'script',A:{type:'text/javascript',lazy:'false'},E:[{T:4,cdata:function(scopeObj){with(scopeObj){
    ...
    scwin.onpageload = function() {
        ...
        try {
            ...
            scwin.Upload_file_choose = WebSquare.language.getMessage( "Upload_file_choose" ) || "파일 선택";
            scwin.Upload_file_span = WebSquare.language.getMessage( "Upload_file_span" ) || "선택된 파일 없음";
            ...
            scwin.Upload_msg18 = WebSquare.language.getMessage( "Upload_msg18" ) || "쓰기 전용 파일이거나 읽을수 없는 파입니다.";
